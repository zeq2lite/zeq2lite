...
!define NAME "ZEQ2-lite"
!define FSNAME "zeq2-lite-q3a"
!define VERSION "0.2"
!define RELEASE "2"
...
!define MULTIUSER_INSTALLMODE_DEFAULT_REGISTRY_KEY "Software\ZEQ2Lite"
!define MULTIUSER_INSTALLMODE_DEFAULT_REGISTRY_VALUENAME "Install_Mode"
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_KEY "Software\ZEQ2lite"
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUENAME "Install_Dir"
!define MULTIUSER_INSTALLMODE_INSTDIR "ZEQ2Lite"
...
!include "MUI2.nsh"
!define MUI_ICON "../zeq2.ico"

; The name of the installer
Name "${NAME}-${VERSION} for ZEQ2-Lite"
...
Function .onInit
  ...
  ReadRegStr $0 SHCTX "Software\ZEQ2Lite" ${MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUENAME}
  IfErrors 0 oninitdone
    MessageBox MB_OK "You need to install the ZEQ2Lite engine first"
    Abort
  oninitdone:
FunctionEnd
