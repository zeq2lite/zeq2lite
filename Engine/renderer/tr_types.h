...
#define RF_LIGHTING_ORIGIN	0x0080		/*
...
#define RDF_NOCUBEMAP		0x0008		/* disable cubemap effects */
#define RDF_NOEFFECTS		0x0010		/* disable post-process effects */
#define RDF_NODISPLAY		0x0020		/* off-screen rendering */
