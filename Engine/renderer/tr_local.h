...
typedef struct model_s {
	...
	md4bHeader_t	*md4;				// only if type == (MOD_MD4 | MOD_MDR)
	md4aHeader_t	*animations;
	int			 numLods;
} model_t;
...
//extern	cvar_t	*r_showbones;					// draws bones
