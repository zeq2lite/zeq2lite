...
//		}
	...
	cgs.media.radarwarningSound = trap_S_RegisterSound( "sound/feedback/radar_warning.wav", qfalse );
	cgs.media.lightspeedSound = trap_S_RegisterSound( "sound/effects/lightspeed.wav", qfalse );
