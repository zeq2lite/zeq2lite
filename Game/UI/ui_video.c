...
static void DriverInfo_MenuDraw( void )
{
	...
	UI_DrawString( 320, 80, "VENDOR", UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, color_white );
	UI_DrawString( 320, 152, "PIXELFORMAT", UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, color_white );
	UI_DrawString( 320, 192, "EXTENSIONS", UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, color_white );

	UI_DrawString( 320, 80+16, uis.glconfig.vendor_string, UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
	UI_DrawString( 320, 96+16, uis.glconfig.version_string, UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
	UI_DrawString( 320, 112+16, uis.glconfig.renderer_string, UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
	UI_DrawString( 320, 152+16, va ("color(%d-bits) Z(%d-bits) stencil(%d-bits)", uis.glconfig.colorBits, uis.glconfig.depthBits, uis.glconfig.stencilBits), UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );

	// double column
	y = 192+16;
	for (i=0; i<s_driverinfo.numstrings/2; i++) {
		UI_DrawString( 320-4, y, s_driverinfo.strings[i*2], UI_RIGHT|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
		UI_DrawString( 320+4, y, s_driverinfo.strings[i*2+1], UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
		y += SMALLCHAR_HEIGHT;
	}

	if (s_driverinfo.numstrings & 1)
		UI_DrawString( 320, y, s_driverinfo.strings[s_driverinfo.numstrings-1], UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, text_color_normal );
}
...
static void GraphicsOptions_GetInitialVideo( void )
{
	...
	s_ivo.vertexshader  = s_graphicsoptions.vertexshader.curvalue;
}
...
static void GraphicsOptions_CheckConfig( void )
{
	...
	for ( i = 0; i < NUM_IVO_TEMPLATES-1; i++ )
	{
		...
		if ( s_ivo_templates[i].anisotropy != s_graphicsoptions.anisotropy.curvalue )
			continue;
		if ( s_ivo_templates[i].vertexshader != s_graphicsoptions.vertexshader.curvalue )
			continue;
...
static void GraphicsOptions_UpdateMenuItems( void )
{
	...
	if ( s_ivo.vertexshader != s_graphicsoptions.vertexshader.curvalue )
	{
		s_graphicsoptions.apply.generic.flags &= ~(QMF_HIDDEN|QMF_INACTIVE);
	}
...
static void GraphicsOptions_ApplyChanges( void *unused, int notification )
{
	...
	if ( s_graphicsoptions.multisample.curvalue == 4 )
	{
		trap_Cvar_Set( "r_ext_multisample", "4" );
	}
	else if ( s_graphicsoptions.multisample.curvalue == 3 )
	{
		trap_Cvar_Set( "r_ext_multisample", "3" );
	}
	else if ( s_graphicsoptions.multisample.curvalue == 2 )
	{
		trap_Cvar_Set( "r_ext_multisample", "2" );
	}
	else if ( s_graphicsoptions.multisample.curvalue == 1 )
	{
	...
	if ( s_graphicsoptions.vertexshader.curvalue == 1 )
	{
		trap_Cvar_Set( "r_ext_vertex_shader", "1" );
	}
	else
	{
		trap_Cvar_Set( "r_ext_vertex_shader", "0" );
	}
...
static void GraphicsOptions_Event( void* ptr, int event ) {
	...
	case ID_LIST:
		...
		s_graphicsoptions.vertexshader.curvalue  = ivo->vertexshader;
...
static void GraphicsOptions_SetMenuItems( void )
{
	...
	case 2:
		...
		break;
	case 3:
		s_graphicsoptions.multisample.curvalue = 3;
		break;
	case 4:
		s_graphicsoptions.multisample.curvalue = 4;
		break;
	}
	...
	s_graphicsoptions.vertexshader.curvalue = trap_Cvar_VariableValue( "r_ext_vertex_shader" ) != 0;
	switch ( ( int ) trap_Cvar_VariableValue( "r_ext_vertex_shader" ) )
	{
	default:
	case 0:
		s_graphicsoptions.vertexshader.curvalue = 0;
		break;
	case 1:
		s_graphicsoptions.vertexshader.curvalue = 1;
		break;
	}
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.graphics.style			= UI_RIGHT|UI_DROPSHADOW;
	...
	s_graphicsoptions.display.style				= UI_RIGHT|UI_DROPSHADOW;
	...
	s_graphicsoptions.sound.style				= UI_RIGHT|UI_DROPSHADOW;
	...
	s_graphicsoptions.network.style				= UI_RIGHT|UI_DROPSHADOW;
	...
	s_graphicsoptions.multisample.generic.name	= "Multisample:";
	...
	s_graphicsoptions.anisotropy.generic.name	= "Texture Anisotropy:";
	...
	s_graphicsoptions.anisotropy.itemnames      = anisotropic_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_ext_vertex_shader"
	s_graphicsoptions.vertexshader.generic.type   	= MTYPE_SPINCONTROL;
	s_graphicsoptions.vertexshader.generic.name		= "Vertex Shader:";
	s_graphicsoptions.vertexshader.generic.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.vertexshader.generic.x	    = 400;
	s_graphicsoptions.vertexshader.generic.y	    = y;
	s_graphicsoptions.vertexshader.itemnames      	= vertexshader_names;
	y += BIGCHAR_HEIGHT+2;
...
//	Menu_AddItem( &s_graphicsoptions.menu, ( void * ) &s_graphicsoptions.list );
	...
	Menu_AddItem( &s_graphicsoptions.menu, ( void * ) &s_graphicsoptions.vertexshader );
