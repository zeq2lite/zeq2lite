...
equ trap_DebugPolygonCreate	-38
equ trap_DebugPolygonDelete	-39
equ trap_RealTime			-40
equ trap_SnapVector			-41
equ trap_TraceCapsule		-42
equ trap_EntityContactCapsule	-43
